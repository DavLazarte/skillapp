...
export function StudentSidebar() {
  ...
  const navItems = [
    { href: `/alumno/${studentId}`, label: "Mi Plan", icon: Calendar },
    { href: `/alumno/${studentId}/rms`, label: "Mis RMs", icon: Dumbbell },
    {
      href: `/alumno/${studentId}/comentarios`,
      label: "Comentarios",
      icon: MessageSquare,
    },
    { href: `/alumno/${studentId}/perfil`, label: "Mi Perfil", icon: User },
  ];
  ...
  const isActive = (href: string) => {
    if (href === `/alumno/${studentId}`)
      return pathname === `/alumno/${studentId}`;
        ...
        <div className="p-6 border-b border-sidebar-border">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Portal del Alumno</p>
            </div>
          </div>
        </div>
